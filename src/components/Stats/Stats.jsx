const Stats = () => {
    return (
        <div className="font">
            <div className="stats bg-linear-to-r from-[#4f39f6] to-[#9514fa] text-white lg:stats-horizontal shadow w-full rounded-none font flex justify-between lg:gap-20 lg:px-50  items-center py-15 text-center">
